...
MSG_PORT_BUSY_CONFIG="Порт %s из конфигурации занят. Освободите порт и повторите попытку."
...
MSG_UFW_ADDING_PORT="Добавление порта %s в UFW..."
MSG_UFW_PORT_ADDED="Порт %s добавлен в UFW"
...
MSG_PROMPT_PUBLIC_HOST="Домен сервера (Enter — пропустить):"
MSG_PROMPT_MAX_CONNECTIONS="Макс. одновр. соединений [%s] (0 — без лимита, Enter — пропустить):"
MSG_INVALID_MAX_CONNECTIONS="Некорректное значение. Введите 0 или положительное целое число."
MSG_PROMPT_GLOBAL_AD_TAG="Глобальный Ad Tag (32 hex символа, из @MTProxybot, Enter — пропустить):"
