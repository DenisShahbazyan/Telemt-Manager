...
MSG_PROMPT_MAX_CONNECTIONS="Max concurrent connections [%s] (0 — unlimited, Enter to skip):"
MSG_INVALID_MAX_CONNECTIONS="Invalid value. Enter 0 or a positive integer."
MSG_PROMPT_GLOBAL_AD_TAG="Global Ad Tag (32 hex chars, from @MTProxybot, Enter to skip):"
